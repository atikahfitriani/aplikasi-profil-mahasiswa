...
class MyApp extends StatelessWidget {
  ...
  MyApp({super.key}) {
    biodata['name'] = 'Atikah Fitriani';
    biodata['image'] = 'profile.jpeg';
    biodata['nim'] = '212221035';
    biodata['prodi'] = 'Informatika';
    biodata['fakultas'] = 'FMIKOM';
    biodata['angkatan'] = '2021';
    biodata['phone'] = '085842442958';
    biodata['email'] = 'atikahfitriani08@gmail.com';
    biodata['addr'] =
        'Desa Cindaga Buntungan Rt 01 Rw 02, Kecamatan Kebasen, Kabupaten Banyumas, Provinsi Jawa Tengah, Indonesia';
  }
